...
import com.sir.mvc.website.model.Parameter;
...
public class HelloMvcController {
    ...
    //本方法将处理数组参数形式的URL  /hello/array?array=123&array=321&array=haha
    ...
    @ResponseBody
    public Parameter getJson(@PathVariable("id") Integer id, @PathVariable("name") String name) {
        Parameter parameter = new Parameter();
        parameter.setId(id);
        parameter.setName(name);
        return parameter;
